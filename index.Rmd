...
et la reproductibilité</strong>, qui sont au cœur d’une démarche
d’analyse de données rigoureuse et efficace. En effet, manipuler ses
données avec Excel implique des opérations invisibles pour une autre
personne que celle qui les a conduites ainsi que la multiplication des
feuilles dans lesquelles sont conduites ces opérations, ce qui les rend
...
R est également est un outil polyvalent qui propose aussi bien des outils
