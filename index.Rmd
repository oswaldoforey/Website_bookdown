...
méthode originale adaptée aux ([débutant-e-s en programmation](#mpd)).
La démarche d'analyse statistique est cependant abordée à travers un
module dédié au package Tidymodels, présentant la démarche de l'analyse
